...
2. [File basics](#file-basics)
   ...
   3. [New line ending](#new-line-ending)
3. [File structure](#file-structure)
   1. [Ordering of file contents](#ordering-of-file-contents)
4. [Formatting](#formatting)
   1. [Indentation](#indentation)
   2. [No excess whitespaces](#no-excess-whitespaces)
   ...
   4. [Data types](#data-types)
      ...
      3. [Mappings](#mappings)
      4. [Strings](#strings)
         1. [Multi-line strings](#multi-line-strings)
